...
import type { AgentConfig } from "@vinhnt-sdk/core";
import type { AgentPermissions } from "@vinhnt-sdk/schema";
...
describe("validateAgentConfig", () => {
  ...
  it("reports missing profile.name", () => {
    const errors = validateAgentConfig({ id: "a1", profile: {} } as AgentConfig);
