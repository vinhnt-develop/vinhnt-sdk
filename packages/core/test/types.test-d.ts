...
describe('Core Package Type Tests', () => {
  describe('AgentKernel', () => {
    it('should have correct config type', () => {
      ...
      expectTypeOf<AgentKernelConfig>().toHaveProperty('maxConcurrentToolCalls');
    });
  });
  ...
  describe('createAgent', () => {
    it('should accept CreateAgentParams', () => {
      ...
      expectTypeOf<CreateAgentParams>().toHaveProperty('profile');
    });
  });

  describe('EventBus', () => {
    it('should have on method', () => {
      expectTypeOf<EventBus>().toHaveProperty('subscribe');
    });
  ...
  describe('Tool System', () => {
    it('Tool should have execute method', () => {
      expectTypeOf<Tool>().toHaveProperty('toDefinition');
    });
  ...
  describe('Knowledge System', () => {
    it('MemoryItem should have required properties', () => {
      ...
      expectTypeOf<MemoryItem>().toHaveProperty('value');
    });
  });
  ...
  describe('Core Types', () => {
    ...
    it('AgentConfig should have required properties', () => {
      ...
      expectTypeOf<AgentConfig>().toHaveProperty('profile');
    });

    it('Session should have required properties', () => {
      expectTypeOf<Session>().toHaveProperty('id');
      expectTypeOf<Session>().toHaveProperty('title');
    });
