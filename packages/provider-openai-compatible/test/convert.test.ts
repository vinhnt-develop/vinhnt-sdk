...
describe("OpenAI Adapter", () => {
  ...
  describe("fromOpenAIStreamChunk", () => {
    ...
    it("converts DeepSeek reasoning_content to a thinking event (RV-44)", () => {
      const chunk: OpenAIStreamChunk = {
        id: "chatcmpl-123",
        object: "chat.completion.chunk",
        created: 1234567890,
    ...
    it("surfaces reasoning tokens from the final usage chunk (RV-44)", () => {
      const chunk: OpenAIStreamChunk = {
        id: "chatcmpl-123",
        object: "chat.completion.chunk",
        created: 1234567890,
  ...
  describe("fromOpenAIError", () => {
    it("redacts an echoed API key from the message (RV-43)", () => {
      const err = {
        error: {
          message: "Incorrect API key provided: sk-shortKey123.",
      ...
      expect(result.message).not.toContain("sk-shortKey123");
