...
import type { Disposable } from "@vinhnt-sdk/core";
import { createDisposable } from "@vinhnt-sdk/core";

/**
 * Plugin manifest and context types.
 */
export type { PluginManifest, PluginContext, PluginHooks, Plugin, Disposable };
