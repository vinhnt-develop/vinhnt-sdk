...
export function createGlobFilesTool(workspaceRoot: RootGetter, ignoredDirs?: string[]): ToolDefinition {
  ...
  return defineTool<{ pattern: string; maxResults?: number | undefined }, string[]>({
    name: "glob_files",
...
export function createGrepFilesTool(workspaceRoot: RootGetter, ignoredDirs?: string[]): ToolDefinition {
  ...
  return defineTool<{ pattern: string; include?: string | undefined; maxResults?: number | undefined }, { file: string; line: number; content: string }[]>({
    name: "grep_files",
