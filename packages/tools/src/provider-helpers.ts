import { ToolProviderRegistry } from "./provider.js";
import { BuiltinToolProvider } from "./providers/builtin-provider.js";
...
export async function createToolProviderRegistry(config: {
  ...
  try {
    const { ToolFileLoader } = await import("./providers/file-loader.js");
